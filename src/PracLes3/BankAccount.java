...
public class BankAccount {
    ...
    public static void main(String[] args) {
        ...
        account.withdraw("0000", 5000); // Неверный PIN. Осталось попыток: 2
        account.withdraw("0000", 5000); // Неверный PIN. Осталось попыток: 1
        bool_result = account.withdraw("0000", 5000); // Счёт заблокирован из‑за трёх неверных попыток ввода PIN.
        System.out.println("[withdraw Успех?: " + bool_result + "]");
